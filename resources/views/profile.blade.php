                                ...
                                <div class="xp-social-profile-img">
                                    <div class="row">
                                        <div class="col-4 px-1">
                                            <img src="{{asset('img/1.jpg') }}" class="rounded img-fluid foto" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('img/2.jpg') }}" class="rounded img-fluid foto" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('img/3.jpg') }}" class="rounded img-fluid foto" alt="img">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-3">
                                            <div class="xp-social-profile-avatar text-center">
                                                <img src="{{asset('img/3.jpg') }}" alt="user-profile" class="rounded-circle img-fluid" style="height: 200px; width: 200px;">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="xp-social-profile-title">
                                                <h5 class="my-1 text-black">Sidna</h5>
                                            </div>
                                            <div class="xp-social-profile-subtitle">
                                                <p class="mb-3 text-muted">Sidna Muhammad Zen</p>
                                            </div>
                                            <div class="xp-social-profile-desc">
                                                <p class="text-muted">"Bismillah Bisa yuk bisa" <br>Kelas 6B Nim 18090144</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
